...
- **Formal Build Report**: `scripts/build_formal.py` and `formal/build_report.json` dynamically track compiled project theorem declarations (currently **107** compiled declarations) and verify them alongside Lean 4 `lake build` compiler output.
